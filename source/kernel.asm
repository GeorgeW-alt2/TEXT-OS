...
option_screen:
	...
	os_init_msg		db 'Welcome to TEXT-OS', 0
	os_version_msg		db 'Version ', MIKEOS_VER, 0

	dialog_string_1		db 'Thanks for trying out TEXT-OS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute TEXT-OS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of TEXT-OS, and', 0
